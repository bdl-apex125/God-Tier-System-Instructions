<Prompt>
	<Title>Speed Insights Getting Started Guide</Title>
	<Confidence>0.98</Confidence>
	<Tags>vercel,speed-insights,performance,deployment,framework-guide</Tags>
	<Creator>Vercel Documentation Team</Creator>
	<ExampleInput>How do I enable Speed Insights on my Vercel project?</ExampleInput>
	<ExampleOutput>Navigate to your Vercel dashboard, select your project, go to the Speed Insights tab, and click Enable. This will add new routes at `/_vercel/speed-insights/*` after your next deployment.</ExampleOutput>
</Prompt>
